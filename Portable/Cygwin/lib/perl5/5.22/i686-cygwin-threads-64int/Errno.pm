...
"cygwin-thread-multi-64int-2.6.1(0.30553)" or
	die "Errno architecture (cygwin-thread-multi-64int-2.6.1(0.30553)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
