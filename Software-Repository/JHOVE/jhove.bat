...
REM *************************************************************************
REM The C:\Users\Friese Yvonne\jhove variable is substituted by the izpack installer at
REM install time.
REM *************************************************************************
SET JHOVE_HOME="C:\Users\Friese Yvonne\jhove"
SET JHOVE_VERSION="1.16.3-RC1"
SET EXTRA_JARS=
